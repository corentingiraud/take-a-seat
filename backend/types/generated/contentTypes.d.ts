...
export interface ApiAvailabilityAvailability
  ...
  attributes: {
    ...
    prepaidCardOnly: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPrepaidCardPrepaidCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    initialBalance: Schema.Attribute.Integer &
...
export interface ApiUnavailabilityUnavailability
  extends Struct.CollectionTypeSchema {
